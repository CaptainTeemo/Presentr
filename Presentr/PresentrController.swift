...
class PresentrController: UIPresentationController, UIAdaptivePresentationControllerDelegate {
	...
	let dismissOnSwipeDistance: CGFloat
    ...
    init(presentedViewController: UIViewController,
		 ...
		 dismissOnSwipeDistance: CGFloat,
		...
		self.dismissOnSwipeDistance = dismissOnSwipeDistance
...
extension PresentrController {
    ...
    func swipeGestureChanged(gesture: UIPanGestureRecognizer) {
        ...
        var swipeLimit: CGFloat = dismissOnSwipeDistance
        if shouldSwipeTop {
